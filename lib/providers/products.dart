...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url = Uri.https('testflutter-a9825-default-rtdb.firebaseio.com',
    ...
    try {
      ...
      url = Uri.https('testflutter-a9825-default-rtdb.firebaseio.com',
  ...
  Future<void> addProduct(Product product) async {
    final url = Uri.https('testflutter-a9825-default-rtdb.firebaseio.com',
